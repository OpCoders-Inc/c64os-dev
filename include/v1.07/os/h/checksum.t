...
maketab_ = $06 ;Make CRC Tables
;  Note: .A decimal number inputs
;  A -> 1,2,4   = 8,16,32
;  A -> 8,16,32 = 8,16,32
;  C <- Set on Error
...
initcrc_ = $09 ;Initialize CRC workspace
;  Note: .A decimal number inputs
;  A -> 1,2,4   = 8,16,32
;  A -> 8,16,32 = 8,16,32
;  C <- Set on Error
